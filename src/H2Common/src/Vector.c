...
vec3_t vec3_origin __attribute__((visibility("default"))) =	{  0.0f, 0.0f,  0.0f }; // [0, 0, 0]
vec3_t vec3_left __attribute__((visibility("default"))) =	{ -1.0f, 0.0f,  0.0f }; // [-1, 0, 0] //mxd. Not exported in original .dll.
vec3_t vec3_right __attribute__((visibility("default"))) =	{  1.0f, 0.0f,  0.0f }; // [1, 0, 0] //mxd. Not exported in original .dll.
vec3_t vec3_up __attribute__((visibility("default"))) =		{  0.0f, 0.0f,  1.0f }; // [0, 0, 1]
vec3_t vec3_down __attribute__((visibility("default"))) =	{  0.0f, 0.0f, -1.0f }; // [0, 0, -1] //mxd. Not exported in original .dll.
